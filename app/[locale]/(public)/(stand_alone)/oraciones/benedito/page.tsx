...
export default function SanBenitoPage() {
  ...
  const image = '/prayer/saobenedito.jpeg';
  const audioUrl = '/prayer/oracaobenedito.MP3'; // Placeholder
          ...
          <div className="mb-6">
            <div className="flex items-start justify-between mb-2">
              <div className="flex-1">
                <h1 className="text-2xl font-bold text-white mb-2">Oración a San Benito</h1>
                <p className="text-gray-300 text-sm">Santo de la Prosperidad</p>
              </div>
              <button
